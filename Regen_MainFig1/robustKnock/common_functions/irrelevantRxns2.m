...
% Modified by Laurence Legon (30/09/21) so only a list of user-supplied
% reactions will be considered, to prevent combinations with essential or
% non-gene-associated reactions from being considered
...
% ADDED CODE SO NON GENE ASSOCIATED REACTIONS AND FORBIDDEN REACTIONS WILL BE IGNORED
irrelevant(~ismember(model.rxns,userRxns))=true;
